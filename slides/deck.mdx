...
import demoSixTwo from "raw-loader!./code/six-two.tsx";
...
<CodeSurfer
  ...
  steps={[
    ...
    {
      lines: [1],
      notes: "And we'll import render() from React Testing Library"
    },
    {
      range: [5, 9],
      notes: "And write a simple Jest test"
    },
    {
      lines: [6],
...
<Layout fullWidth={true}>
  <Jest title="should render the text 'Hello, world!'" shouldPass={true} />
</Layout>
...
<CodeSurfer
  ...
  steps={[
    ...
    {
      range: [11, 13],
      notes: "And conditionally set the 'Loading...' text"
    },
    {
      range: [18, 24],
    ...
    {
      lines: [23],
      notes: "And then we assert on the text content of the button has changed"
    }
  ]}
/>
...
<CodeSurfer
  ...
  steps={[
    {
      range: [2, 6],
      notes: "Let's refactor to support additional loading status strings"
    },
    {
      range: [11, 15],
...
<CodeSurfer
  ...
  steps={[
    ...
    {
      lines: [42, 44],
      notes: "We click the button and expect the correct display value"
    }
  ]}
/>
...
<CodeSurfer
  title="Demo #6.2 - Async requests"
  code={demoSixTwo}
  lang="jsx"
  steps={[
    {
      lines: [39],
      notes: "We need to turn it into an async test"
    },
    {
      lines: [44],
...
<Layout fullWidth={true}>
  <Jest title="should call the onSubmit prop with..." shouldPass={true} />
</Layout>
...
>
  <li>✅ Server-side render + hydration</li>
  <li>✅ Unmounting behaviour</li>
  <li>✅ Re-render on prop changes</li>
  <li>
    ✅ Test custom hooks via <code>@testing-library/react-hooks</code>
  </li>
  <li>
    ✅ Human-like events via <code>@testing-library/user-events</code>
  </li>
</ul>
...
<Appear>
  ...
  >
    <li>
      ✅ React Native via <code>@testing-library/react-native</code>
    </li>
  </ul>
</Appear>
...
<Jest title="should get to the end of the talk" shouldPass={true} />
